...
public abstract class RepeaterBlockMixin
{
	@ModifyExpressionValue(
			...
			at = @At(
					value = "INVOKE",
					target = "Lnet/minecraft/block/RepeaterBlock;canPlaceAbove(Lnet/minecraft/world/WorldView;Lnet/minecraft/util/math/BlockPos;Lnet/minecraft/block/BlockState;)Z"
			),
			allow = 1
	)
