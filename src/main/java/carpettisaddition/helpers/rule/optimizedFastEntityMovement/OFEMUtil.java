...
public class OFEMUtil
{
	...
	public static Iterable<VoxelShape> getAxisOnlyBlockCollision(OFEMContext context, CollisionBoxGetter collisionBoxGetter)
	{
	...
	public static Iterable<VoxelShape> getAxisOnlyBlockCollision(OFEMContext context)
	{
