...
public class Messenger
{
	...
	// TODO: yeets style
	public static MutableText fancy(@Nullable String carpetStyle, @NotNull MutableText displayText, @Nullable MutableText hoverText, @Nullable ClickEvent clickEvent)
	{
	...
	private static MutableText __vector(String style, String displayText, String detailedText)
	{
	...
	public static MutableText vector(String style, Vec3d vec) {return __vector(style, TextUtil.vector(vec), TextUtil.vector(vec, 6));}
	public static MutableText vector(Vec3d vec) {return vector(null, vec);}
