...
public abstract class PhantomEntity_renewableElytraMixin extends FlyingEntity
{
	public PhantomEntity_renewableElytraMixin(EntityType<? extends PhantomEntity> entityType, World world)
	{
