...
public class DamageLogger extends AbstractLogger
{
	...
	public class Tracker
	{
		...
		private MutableText[] verifyAndProduceMessage(String option, PlayerEntity player, Entity from, Entity to, Supplier<MutableText[]> messageFuture)
		{
		...
		private MutableText getAmountText(@Nullable String style, float amount)
		{
		...
		public void flush(float finalAmount, float remainingHealth)
		{
			...
			DamageLogger.this.log((option, player) ->
					this.verifyAndProduceMessage(option, player, attacker, target, () -> {
						...
						MutableText targetName = Messenger.entity("b", target);
