...
public class MicroTimingMessage
{
	...
	public MicroTimingMessage(DimensionType dimensionType, BlockPos pos, DyeColor color, BaseEvent event, TickStage stage, String stageDetail, TickStageExtraBase stageExtra, StackTraceElement[] stackTrace)
	{
	...
	public MicroTimingMessage(MicroTimingLogger logger, DimensionType dimensionType, BlockPos pos, DyeColor color, BaseEvent event)
	{
