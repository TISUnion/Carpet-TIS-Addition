...
public class SupplierCounter extends TranslationContext
{
	...
	private final MutableText prettyName;
	...
	public MutableText reportBrief(boolean realTime)
	{
		MutableText content;
		if (this.isRunning())
		{
	...
	public List<MutableText> report(boolean realTime)
	{
		if (!this.isRunning())
		{
		...
		MutableText realtimeSuffix = realTime ?
